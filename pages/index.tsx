import { Box, Container, Heading, SimpleGrid, Text, Button, Flex, Badge, Image, Icon, Divider } from '@chakra-ui/react';
      ...
      >
        <Box>
          ...
          <Text className="text-gray-600 mt-2">
            Find and join gaming events near you or create your own!
          </Text>
        </Box>
